...
const projectsData = [
  ...
  },
  {
    id: 2,
    title: "Furnio",
    description: "Furnio is a full-stack, monorepo-based e-commerce application built with Next.js and Django using TypeScript. It follows a modular, scalable architecture with a clear separation between frontend and backend layers. The backend exposes structured REST APIs, while PostgreSQL is used for managing relational e-commerce data.",
    image: "/images/projects/furnio.png",
    tag: ["All", "Web"],
    gitUrl: "https://github.com/Abhishek-jha-96/Furnio",
    previewUrl: "/",
  },
  {
    id: 3,
